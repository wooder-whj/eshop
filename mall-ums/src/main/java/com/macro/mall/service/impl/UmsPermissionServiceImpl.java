...
public class UmsPermissionServiceImpl implements UmsPermissionService {
    ...
    @Override
    @CacheEvict(value = {"UmsPermissionServiceImpl.list","UmsPermissionServiceImpl.treeList"},allEntries = true)
    ...
    @Override
    @Cacheable(value = "UmsPermissionServiceImpl.treeList")
    ...
    @Override
    @Cacheable(value = "UmsPermissionServiceImpl.list")
