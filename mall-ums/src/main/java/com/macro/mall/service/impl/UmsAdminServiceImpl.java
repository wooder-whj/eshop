...
import com.macro.mall.security.service.JwtTokenService;
...
//    @Reference(version = "${dubbo.service.version}",group = "${dubbo.registry.group}",check =false )
    ...
    @Override
    @Cacheable(value = "UmsAdminServiceImpl.getAdminByUsername",key = "#username")
    ...
    @Override
    @CacheEvict(value = {"UmsAdminServiceImpl.getAdminByUsername","UmsAdminServiceImpl.getItem","UmsAdminServiceImpl.getPermissionList","UmsAdminServiceImpl.getResourceList","UmsAdminServiceImpl.getRoleList","UmsAdminServiceImpl.list"}, allEntries = true)
     ...
     * @param username 用户名
     */
    private void insertLoginLog(String username,String ip) {
...
//        HttpServletRequest request = attributes.getRequest();
    ...
    public String refreshToken(String oldToken) {
        return jwtTokenService.refreshHeadToken(oldToken);
    }

    @Override
    @Cacheable(value = "UmsAdminServiceImpl.getItem",key = "#id")
    public UmsAdmin getItem(Long id) {
        return adminMapper.selectByPrimaryKey(id);
    }

    @Override
    @Cacheable(value = "UmsAdminServiceImpl.list")
    ...
    @Override
    @Cacheable(value = "UmsAdminServiceImpl.getRoleList",key = "#adminId")
    public List<UmsRole> getRoleList(Long adminId) {
        return adminRoleRelationDao.getRoleList(adminId);
    }

    @Override
    @Cacheable(value = "UmsAdminServiceImpl.getResourceList",key = "#adminId")
    ...
    @Override
    @Cacheable(value = "UmsAdminServiceImpl.getPermissionList",key = "#adminId")
