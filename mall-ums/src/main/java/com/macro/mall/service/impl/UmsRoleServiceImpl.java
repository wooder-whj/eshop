...
public class UmsRoleServiceImpl implements UmsRoleService {
    ...
    @Override
    @CacheEvict(value = {"UmsRoleServiceImpl.list","UmsRoleServiceImpl.list"},allEntries = true)
    ...
    @Override
    @CacheEvict(value = {"UmsRoleServiceImpl.list",
            "UmsRoleServiceImpl.getMenuList","UmsRoleServiceImpl.getPermissionList",
            "UmsRoleServiceImpl.listMenu","UmsRoleServiceImpl.listResource"},allEntries = true)
    ...
    @Override
    @Cacheable(value = "UmsRoleServiceImpl.getPermissionList",key = "#roleId")
    ...
    @Override
    @Cacheable(value = "UmsRoleServiceImpl.list")
    ...
    @Override
    @Cacheable(value = "UmsRoleServiceImpl.getMenuList",key = "#adminId")
    public List<UmsMenu> getMenuList(Long adminId) {
        return roleDao.getMenuList(adminId);
    }

    @Override
    @Cacheable(value = "UmsRoleServiceImpl.listMenu",key = "#roleId")
    public List<UmsMenu> listMenu(Long roleId) {
        return roleDao.getMenuListByRoleId(roleId);
    }

    @Override
    @Cacheable(value = "UmsRoleServiceImpl.listResource",key = "#roleId")
