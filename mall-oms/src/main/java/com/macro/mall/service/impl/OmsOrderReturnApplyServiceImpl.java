...
public class OmsOrderReturnApplyServiceImpl implements OmsOrderReturnApplyService {
    ...
    @Override
    @Cacheable(value = "OmsOrderReturnApplyServiceImpl.list")
    ...
    @Override
    @CacheEvict(value = {"OmsOrderReturnApplyServiceImpl.list","OmsOrderReturnApplyServiceImpl.getItem"},allEntries = true)
    ...
    @Override
    @Cacheable(value = "OmsOrderReturnApplyServiceImpl.getItem",key = "#id")
