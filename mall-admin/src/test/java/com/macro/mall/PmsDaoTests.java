...
public class PmsDaoTests {
    ...
    public void testRegister() throws Exception{
        ...
        umsAdminParam.setUsername("wooder");
        umsAdminParam.setPassword("123456");
        umsAdminParam.setEmail("123456@qq.com");
        umsAdminController.register(umsAdminParam,null);
    }

//    @Test
//    public void testUpdatePassword() throws Exception{
//        UpdateAdminPasswordParam umsAdminParam = new UpdateAdminPasswordParam();
//        umsAdminParam.setUsername("admin");
//        umsAdminParam.setPassword("123456");
//        umsAdminController.updatePassword(umsAdminParam);
//    }
