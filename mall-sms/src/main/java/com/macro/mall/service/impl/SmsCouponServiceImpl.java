...
public class SmsCouponServiceImpl implements SmsCouponService {
    ...
    @Override
    @CacheEvict(value = {"SmsCouponServiceImpl.list"},allEntries = true)
    ...
    @Override
    @Cacheable(value = "SmsCouponServiceImpl.list")
    ...
    @Override
    @Cacheable(value = "SmsCouponServiceImpl.getItem",key = "#id")
